    ...
    <>
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-semibold text-slate-800">{isEdit ? 'Edit Log' : 'Review Details'}</h2>
      ...
      <p className="text-slate-600 mb-8">
        {isEdit ? 'Update the information below.' : 'Please verify the extracted information before saving.'}
      </p>
